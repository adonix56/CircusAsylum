...
void AAIProjectCharacter::SetupStimulusSource()
{
...
void AAIProjectCharacter::ToggleCameraSwitch()
{
	bFirstCamera = !bFirstCamera;
	if (bFirstCamera) {
		GetMesh()->SetSkeletalMesh(FirstSkeletalMesh);
		CameraBoom->TargetArmLength = 0.f;
		CameraBoom->SetRelativeLocation(FVector(0.f, 0.f, 74.f));
		bUseControllerRotationYaw = true;
	}
	else {
		GetMesh()->SetSkeletalMesh(ThirdSkeletalMesh);
